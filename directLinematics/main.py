...
if r31!=1 and r31!=-1:
    ...
    print('Углы Тейта-Брайана(ZYX) (r31!=+-1): ', gammaAngle, bettaAngle, alphaAngle)
elif r31==-1:
    #В таком случае можно использовать один из 2 способов поиска суммы gamma и alpha
    sumGammaAlpha=round(math.degrees(math.atan2(r23, r22)), 2)
    #sumGammaAlpha=round(math.degrees(math.atan2(r12, r13)), 2)
    print('Сумма альфа и гамма (r31=-1): ', sumGammaAlpha)
    ...
    bettaAngle=round(math.degrees(math.asin(-r31)))
    print('Углы Тейта-Брайана(ZYX) (r31!=+1): ', gammaAngle, bettaAngle, alphaAngle)
    gammaAngle = 0
    alphaAngle = sumGammaAlpha - gammaAngle
    print('Углы Тейта-Брайана(ZYX) (r31!=+1): ', gammaAngle, bettaAngle, alphaAngle)
elif r31==1:
    difGammaAlpha=round(math.degrees(-math.atan2(r12, r13)), 2)
    #difGammaAlpha=round(math.degrees(-math.atan2(r23, r22), 2)
